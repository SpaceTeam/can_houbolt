...
typedef enum
{
	DIGITAL_OUT_REQ_RESET_SETTINGS,		// NO payload
	DIGITAL_OUT_RES_RESET_SETTINGS,		// NO payload
	DIGITAL_OUT_REQ_STATUS,				// NO payload
	DIGITAL_OUT_RES_STATUS,				// TODO: some status msg
